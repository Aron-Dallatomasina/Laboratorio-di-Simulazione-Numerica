...
void Averages(int iblk) {
	...
	Ene.open(full_dir+"/ene_T"+Ts.str()+".dat",ios::app);
	Heat.open(full_dir+"/heat_T"+Ts.str()+".dat",ios::app);
	Mag.open(full_dir+"/mag_T"+Ts.str()+".dat",ios::app);
	Chi.open(full_dir+"/chi_T"+Ts.str()+".dat",ios::app);
