...
int			iv, ik, it, ie, ip;											// Indices of the observables in the walker array (potential, kinetic, temperature, total energy, pressure)
...
double		err_pot, err_press, err_kin, err_etot, err_temp, err_gdir;	// Statistical uncertainties (data blocking)
